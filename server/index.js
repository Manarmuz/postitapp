...
const constr=`mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@postitcluster.ipp622m.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority&appName=PostITCluster`
